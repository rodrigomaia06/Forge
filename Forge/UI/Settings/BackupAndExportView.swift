    ...
    private func exportWorkoutData(asJSON: Bool) {
        ...
        do {
            ...
            if asJSON {
                ...
                let text = workouts.compactMap { $0.logText(in: exerciseStore.exercises, weightUnit: settingsStore.weightUnit, bodyweight: settingsStore.bodyweight) }.joined(separator: "\n\n\n\n\n")
